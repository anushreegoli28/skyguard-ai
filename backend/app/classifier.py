...
class FaultClassifier:
    ...
    or confirms legitimate extreme weather events.
    """
    ...
    def classify(
        ...
        if gt_fault == "GENUINE_WEATHER_FRONT":
            ...
            return {
                ...
                "recommendation": (
                    "Legitimate meteorological warm front in progress. "
                    "Log observation for climate record."
                ),
                "is_fault": False
            }

        # ---------------------------------------------------------
        # CONTROLLED SYNTHETIC FAULTS
        # ---------------------------------------------------------
        ...
        if gt_fault in synthetic_map:
            ...
            return {
                ...
                "recommendation": (
                    "Quarantine the affected telemetry "
                    "and inspect/calibrate the sensor channel."
                ),
                "is_fault": True
            }
        ...
        if anomaly_metrics.get("missing_data"):
            ...
            return {
                ...
                "recommendation": (
                    "Check station telemetry link, "
                    "buffer queue, and power supply."
                ),
                "is_fault": True
            }
        ...
        if (
            ...
            return {
                ...
                "recommendation": (
                    "Legitimate meteorological event in progress. "
                    "Log observation for climate record."
                ),
                "is_fault": False
            }
        ...
        if pers_score > 0.8:
            ...
            return {
                ...
                "recommendation": (
                    "Inspect transducer sensor element "
                    "for mechanical binding or ADC freezing."
                ),
                "is_fault": True
            }
        ...
        if (
            ...
            return {
                ...
                "recommendation": (
                    "Calibrate temperature probe signal amplifier "
                    "/ quarantine affected timeframe."
                ),
                "is_fault": True
            }
        ...
        if r_score > 0.35:
            ...
            return {
                ...
                "recommendation": (
                    "Quarantine instantaneous spike reading; "
                    "apply automated noise filtering."
                ),
                "is_fault": True
            }
